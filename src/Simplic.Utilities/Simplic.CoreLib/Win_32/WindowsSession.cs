...
namespace Simplic.Win32
{
    ...
    public class WindowsSession
    {
        ...
        private static extern bool GetUserObjectInformation(IntPtr hObj, int nIndex, [MarshalAs(UnmanagedType.LPArray)] byte[] pvInfo, int nLength, out uint lpnLengthNeeded);
